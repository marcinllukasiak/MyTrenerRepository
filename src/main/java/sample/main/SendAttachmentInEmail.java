...
public class SendAttachmentInEmail {
    ...
    public static void sendRecoveryPassword(String nick, String passwordA , String email) {
        // Recipient's email ID needs to be mentioned.
        String to = email;
        ...
        try {
            ...
            // Set Subject: header field
            message.setSubject("Przypomnienie hasła do konta");
            ...
            String htmlText = "<h2>Ktoś próbował odzyskać hasło do konta "+nick +" <h2/>" +
                    "<br/>Jeśli nie Ty użyłeś tej opcji to po prostu zignoruj tego maila." +
                    "<br/>Twoje hasło to: "+passwordA+"";
